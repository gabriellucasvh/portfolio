    ...
    <div className="flex flex-col items-center w-full px-4 md:px-16 py-8 select-none" id='sobre'>
      ...
      <div className='flex flex-col md:flex-row items-center w-full'>
        ...
        <div className="flex flex-col items-center md:items-start w-full md:w-3/4 lg:w-1/2 mt-5 font-extralight text-base md:text-lg px-4 md:px-6 py-4">
          <p className="indent-5 text-justify hyphens-auto" style={{ wordSpacing: '-1.4px' }}>
          ...
          <p className="indent-5 text-justify mt-4 hyphens-auto" style={{ wordSpacing: '-1.4px' }}>
        ...
        <div className='flex flex-col items-center justify-center md:items-start w-full md:w-3/4 lg:w-1/2 mt-5 font-extralight '>
          <div className='flex flex-col items-center md:items-start border-x dark:border-gray-700 px-4 md:px-6 py-4'>
            ...
            <p className='border-b dark:border-gray-700 text-center mt-2 md:text-start'>
